...
3. Save the file as `nfl.csv` in the `data/raw_data/` folder.
...
|---|---|---|---|
| NFL team dataset | `nfl.csv` | **[https://www.pro-football-reference.com/teams/](https://www.pro-football-reference.com/teams/https://www.pro-football-reference.com/teams)** |[3/12/2026] |
| NBA team dataset | `nba.csv` | **[https://www.basketball-reference.com/teams/](https://www.basketball-reference.com/teams/)** |[3/12/2026] |
| MLB team dataset | `mlb.csv` | https://www.baseball-reference.com/teams/ |[3/12/2026] |
...
```bash
shasum -a 256 data/raw_data/*.csv > checksums.txt
